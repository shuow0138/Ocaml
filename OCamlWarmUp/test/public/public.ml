...
let test_rev_tup _ =
  ...
  assert_equal ("a", true, 1) (rev_tup (1, true, "a")) ~msg:"rev_tup (5)"
...
let test_is_odd _ =
 ...
 assert_equal true (is_odd (-13)) ~msg:"is_odd (5)";
 assert_equal false (is_odd (-4)) ~msg:"is_odd (6)"
...
let test_area _ =
  ...
  assert_equal 16 (area ((-1), (-1)) (3, 3)) ~msg:"area (5)";
  assert_equal 28 (area ((-2), (-3)) (2, 4)) ~msg:"area (6)"
...
let test_volume _ =
  ...
  assert_equal 1 (volume ((-2), (-2), (-2)) ((-1), (-1),(-1))) ~msg:"volume (6)";
  assert_equal 27(volume ((-1), (-2), (-3)) (2, 1, 0)) ~msg:"volume (7)"
...
let test_pow _ =
  ...
  assert_equal 1 (pow (-3) 0) ~msg:"pow (7)";
  assert_equal 9 (pow (-3) 2) ~msg:"pow (8)"
...
let test_is_prime _ =
  ...
  assert_equal false (is_prime (-2)) ~msg:"is_prime (8)"
